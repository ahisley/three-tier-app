...
export class CdkThreeTierServerlessStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    //Dynamo Table setup, including IAM access for read/write functions
    ...
    //HTTP Gateway setup for our API
    ...
    //Crn output so we can see and reuse our API URL (no custom domain in this setup)
